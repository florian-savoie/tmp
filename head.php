      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="/tmp/index.php" target="_blank" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold ms-2">profond-ui</span>
          </a>
        ...
        <ul class="menu-inner py-1">
          ...
          <!-- Apps & Pages -->
          <li class="menu-item">
            <a href="/tmp/tmp/tmp/index.html" class="menu-link">
              <i class="menu-icon tf-icons mdi mdi-star-outline"></i>
              <div >Template d'origine</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="/tmp/configuration.php" class="menu-link">
              <i class="menu-icon tf-icons mdi mdi-cog"></i>
              <div >Configuration</div>
            </a>
          </li>
          <li class="menu-item">
            <a href="/tmp/structure.php" class="menu-link">
